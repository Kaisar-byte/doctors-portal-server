...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.i2wvmgk.mongodb.net/?retryWrites=true&w=majority`;
  ...
  try {
    ...
    app.post("/bookings", async (req, res) => {
      ...
      if (alreadyBooked.length) {
        const message = `you have a booking on ${bookings.appointmentDate}`;
    ...
    //     },
    //   };
    //   const result = await appointOptionCollection.updateMany(
    //     filter,
    //     updatedDoc,
    //     options
    //   );
